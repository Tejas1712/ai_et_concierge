...
class TestConversationOrchestrator:
    ...
    def test_inject_system_prompt_includes_catalog(self, orchestrator):
        ...
        assert "ecosystem concierge" in system_prompt.lower()
    ...
    def test_reset_conversation(self, orchestrator):
        ...
        orchestrator.conversation_history = [Message(role="user", content="test")]
    ...
    def test_recommendations_triggered_after_turn_3(self, orchestrator):
        ...
        orchestrator.current_persona = Persona(
            professional_background="Engineer", financial_goals="Growth"
        )
            ...
            with patch("core.orchestrator.CatalogLoader") as mock_catalog:
                ...
                with patch.object(
                    ...
                    return_value=Persona(
                        professional_background="Engineer", interests=["Tech"]
                    ),
                ):
                    mock_response = Mock()
                    mock_response.content = "Response"
                    ...
                    assert (
                        ...
                        or persona.financial_goals
                        or persona.risk_appetite
                        or persona.interests
                    )
